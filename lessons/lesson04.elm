...
cube =
  ...
  in
    Triangle << List.concat <|
      [ cubeFace (vec3 1 0 0) rft rfb rbb rbt   -- right
      , cubeFace (vec3 1 1 0) rft rfb lfb lft   -- front
      , cubeFace (vec3 0 1 0) rft lft lbt rbt   -- top
      , cubeFace (vec3 1 0.5 0.5) rfb lfb lbb rbb   -- bottom
      , cubeFace (vec3 1 0 1) lft lfb lbb lbt   -- left
      , cubeFace (vec3 0 0 1) rbt rbb lbb lbt   -- back
      ]
